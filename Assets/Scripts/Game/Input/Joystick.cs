...
namespace Game.Input
{
    public class Joystick : EnablerMonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            _maxMovement = _currentVisuals.RectTransform.sizeDelta.x * _scaleFactor * 0.5f;
            Vector3 startingPosition = new Vector3(Screen.width * 0.5f, _currentVisuals.RectTransform.anchoredPosition.y * _scaleFactor, 0.0f);
